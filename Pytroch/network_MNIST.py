...
class StudentNetwork_noRelu(nn.Module):
    def __init__(self):
        ...
        self.conv1 = FFT_Conv_Layer(imgSize=28, inCs=1, outCs=32, imagDim=2, filtSize=3, cuda=True)
        self.conv2 = FFT_Conv_Layer(imgSize=28, inCs=32, outCs=64, imagDim=2, filtSize=3, cuda=True)
        self.conv3 = FFT_Conv_Layer(imgSize=28, inCs=64, outCs=256, imagDim=2, filtSize=3, cuda=True)
